...
#define TIM2_ovf_512us() TCCR2B &= ~(1<<CS22); TCCR0B |= (1<<CS21) | (1<<CS20);

/** @brief Set overflow 1ms, prescaler 100 --> 64 */
#define TIM2_ovf_1ms() TCCR2B |= (1<<CS22); TCCR2B &= ~(1<<CS21) | (1<<CS20);

/** @brief Set overflow 2ms, prescaler 101 --> 128 */
#define TIM2_ovf_2ms() TCCR2B &= ~(1<<CS21); TCCR0B |= (1<<CS22) | (1<<CS20);

/** @brief Set overflow 4ms, prescaler // 110 --> 256 */
#define TIM2_ovf_4ms() TCCR2B &= ~(1<<CS20); TCCR0B |= (1<<CS22) | (1<<CS21);

/** @brief Set overflow 16ms, prescaler // 111 --> 1024 */
#define TIM2_ovf_16ms() TCCR0B |= (1<<CS22) | (1<<CS21) | (1<<CS20);
